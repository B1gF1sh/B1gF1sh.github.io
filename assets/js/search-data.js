...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "nav-selected-github-projects",
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-get-admitted-to-polito-bachelor-s-program-in-computer-engineering",
          title: 'Get admitted to PoliTO, Bachelor’s program in Computer Engineering.',
          description: "",
          section: "News",},{id: "projects-simd-optimization-case-study",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%62%65%72%6B%61%6C%69.%64%65%6D%69%72@%73%74%75%64%65%6E%74%69.%70%6F%6C%69%74%6F.%69%74", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/B1gF1sh", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
